...
% Работа на Алмазе
\cvevent{\textbf{Engineer Assistant}}{\href{https://ras[letin.com}{SPA (NPO) <<Almaz>>, R\&D dept.}}{12.18 -- present}{Moscow, Russia}

Re-entry hypersonic venicle trajectory generation, simulation, and classification using LSTM-based networks
