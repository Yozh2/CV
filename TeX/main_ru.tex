...
% MIL
\cvevent{\textbf{Data Scientist}}{\href{https://mipt.ru/science/labs/machine-intelligence/}{Лаборатория Машинного Интеллекта К.В.  Воронцова}}{09.18 -- по н.вр.}{МФТИ, Долгопрудный, Россия}
...
Алгоритм генерации, симуляции и классификации гиперзвуковых летательных аппаратов с применением нейронных сетей
...
% Лаба на Алмазе
\cvevent{\textbf{Лаборант}}{\href{http://miptdesigncenter.tilda.ws}{Лаборатория моделирования и проектирования архитектур специальных вычислительных систем}}{10.17 -- 12.18}{МФТИ, Долгопрудный, Россия}
